...
return ['pages' => [
    'pricing' => [
        ...
        'free_description' => 'Essential tools for short everyday EV journeys.', 'monthly_description' => 'A flexible monthly plan you can cancel at any time.', 'yearly_description' => 'The best value for year-round travel — only €3.33 per month.',
        'per_month' => '/ month', 'per_year' => '/ year', 'recommended' => 'Recommended',
        'free_features' => ['2 route plans per day', 'Routes up to 300 km', '1 vehicle', 'Essential station filters'],
        ...
        'comparison' => [
            ['Plans per day', '2', 'Unlimited'], ['Maximum distance', '300 km', 'Unlimited'], ['Garage vehicles', '1', 'Unlimited'],
    ...
    'about' => [
        'seo_title' => 'About EVSmartRoute', 'seo_description' => 'Our mission for more predictable electric journeys.', 'eyebrow' => 'About us', 'title' => 'Built for the reality of EV travel.', 'intro' => 'EVSmartRoute connects fragmented vehicle, route and charging data into one understandable product.',
        'sections' => [
            ['icon' => '◎', 'title' => 'Mission', 'text' => 'Remove uncertainty from longer electric journeys.', 'items' => ['Clear forecasts', 'Regional focus']],
            ['icon' => '◇', 'title' => 'Principles', 'text' => 'Transparency, practical technology and honest limitations.', 'items' => ['No false precision', 'Privacy by design']],
        ],
    ],
    'faq' => [
        ...
        'sections' => [
            ...
            ['icon' => '€', 'title' => 'Is there a free plan?', 'text' => 'Yes. FREE includes up to two daily plans and routes up to 300 km.'],
        ],
    ],
    'contact' => [
